...
- [SPEC-04 — Eval Pipeline](SPEC-04-2026-07-eval-pipeline.md) — freeze real accept/dismiss decisions as eval cases, batch-run them through a snapshotted agent config, and score recall/precision/citation_accuracy with zero LLM calls (approved)
